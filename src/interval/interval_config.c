...
bool interval_rest_after_last_workout = REST_AFTER_LAST_WORKOUT_DEFAULT;
...
void interval_read_persistent() {
	...
	interval_rest_after_last_workout = persist_exists(REST_AFTER_LAST_WORKOUT_PKEY) ? persist_read_bool(REST_AFTER_LAST_WORKOUT_PKEY) : REST_AFTER_LAST_WORKOUT_DEFAULT;
}
...
void interval_write_persistent() {
	...
	persist_write_bool(REST_AFTER_LAST_WORKOUT_PKEY, interval_rest_after_last_workout);
}
